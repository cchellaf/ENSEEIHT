		...
		<div class="row content-items">
			<div class="col-12">
				<div class="section-heading">
					<div class="section-subheading">Information personnelle - Administrateur</div>
							</div>
						</div>
...
<p>			
<h5><%out.println("Nom : " + c.getNom() );%><br>
...
<div class="col-xl-4 col-sm-6 col-12">	
          <a href="changementMDP.jsp" class="btn btn-with-icon btn-small ripple">     <!-- Changer le lien -->
                     ...
                     <svg class="btn-icon-right" viewBox="0 0 13 9" width="13" height="9"><use xlink:href="assets/img/sprite.svg#arrow-right"></use></svg>
                         ...
                         <br>
             <a href="ajoutVol.jsp" class="btn btn-with-icon btn-small ripple">     <!-- Changer le lien -->
           <span  style="font-weight: bold">Ajouter un vol</span>
               <svg class="btn-icon-right" viewBox="0 0 13 9" width="13" height="9"><use xlink:href="assets/img/sprite.svg#arrow-right"></use></svg>
                  </a>
</div>
