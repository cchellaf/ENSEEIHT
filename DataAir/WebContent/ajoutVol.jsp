            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="Main" method="get" class="register-form" id="register-form">
                            <div class="form-group">
                                <label for="num_vol"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="num_vol" id="num_vol" placeholder="Numero de Vol"/>
                            </div>
                            <div class="form-group">
                                <label for="depart"><i class="zmdi zmdi-email"></i></label>
                                <input type="text" name="depart" id="depart" placeholder="Depart"/>
                            </div>
                            <div class="form-group">
                                <label for="arrivee"><i class="zmdi zmdi-lock"></i></label>
                                <input type="text" name="arrivee" id="pass" placeholder="Arrivee"/>
                            </div>
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="heure"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="text" name="heure" id="heure" placeholder="Heure"/>
                            </div>
                            <div class="form-group">
                                <label for="place_dispo"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="text" name="place_dispo" id="heure" placeholder="Places Disponibles"/>
                            </div>
                            <div class="form-group form-button">
                                <input type="submit" name=op id="ajoutVol" class="form-submit" value="AjouterVol"/>
                            </div>
                        </form>
                    </div>
