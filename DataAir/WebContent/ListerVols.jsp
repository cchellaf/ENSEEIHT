<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import= "java.util.Collection" import="entities.Client" import="entities.*"%>
...
<div class="centrage">Choisir le vol:<br></div>
<%
Collection<Vol> lv = (Collection<Vol>) request.getAttribute("listeVols");
for (Vol  vol : lv) {
	//String s = "Depart de " + (vol.getDepart()) + "Arrivee a " + (vol.getArrivee())+ "le " + vol.getDate();
	String numvol = "Vol numero : " + (vol.getNum_vol()) ;
	String depart = " - Depart : " + (vol.getArrivee()) ;
	String arrivee = " - Arrivee : " + (vol.getArrivee()) ;
	String date = " - Date  : " + (vol.getDate());
	String s = numvol + "\n" + depart + "\n" + arrivee + "\n" + date +  "\n";
	%>
<input type="radio" name="IdVol" value="<%=vol.getId()%>"> <%=s %><br>
...
color: #282727;
border: none;
border-radius: 3px;" type="submit" name="op"  value="reserver">
