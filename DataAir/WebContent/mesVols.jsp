...
<p style="margin: 0 65px; text-align: justify;">

<% if (vols==null) {
	out.println("liste null");
} else {
	%> <h5> Liste de vos vols </h5> 
	<%
	for ( Vol v : vols){ 
    ...
    out.println(" Heure du vol : " + v.getHeure() + "<br>");
