...
| TInt of Int
| TRat of Rat
| TPointeur of Pointeur _
| TTNomme of TNomme *)
(**Pour l'analyse des enregistrements *)
type types = unit
...
type affectable = 
  | Ident of string
  | Deref of affectable  
  (*Acces au champ d'un enregistrement *)
  |AccesChamp of affectable * string  
...
type expression =
  ...
  (* Definition d'un nouveau pointeur *)
  | New of typ
  (* Adresse d'un pointeurs *)
  | Adresse of string 
  (* Null *)
  | Null 
  (* liste d'affectation d'un enregistrement*) 
  | StructAffect of  expression list
...
and instruction =
  ...
  |AssignAdd of  affectable * expression 
  (*Definition des types nomme *) 
  | DeclTypeNomme of string * typ
...
struct
  ...
  type types = 
   |TypeBase of typ  (*regroupe Bool, Int , Rat, Pointeur_ , TNomme _ *)
   |Enregistr of (typ * Tds.info_ast) list  (*regroupe les enregistrement pour leur faire des traitement particuliers *)
          
  (* Affectables de Rat *)
  type affectable = 
    | Ident of Tds.info_ast
    | Deref of affectable
    |AccesChamp of affectable * Tds.info_ast
  ...
  and instruction =
    ...
    | AssignAdd of  affectable * expression 
    | DeclTypeNomme of  Tds.info_ast * typ
  ...
  type programme = Programme of (Tds.info_ast * typ) list * fonction list * bloc
...
type types = 
   |TypeBase of typ 
   |Enregistr of (types * Tds.info_ast) list
...
type bloc = instruction list
 and instruction =
  ...
  | Empty (* les nœuds ayant disparus: Const *)
  | AssignAdd of  affectable * expression 
  | DeclTypeNomme of  Tds.info_ast 
  
(* informations associées à l'identificateur (dont son nom), liste des paramètres, corps *)
type fonction = Fonction of Tds.info_ast * Tds.info_ast list * bloc

(* Structure d'un programme dans notre langage *)
type programme = Programme of (Tds.info_ast) list * fonction list * bloc
