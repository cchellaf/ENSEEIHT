...
% Bas du visage
bas_visage = img2(ligne_min:ligne_max,colonne_min:colonne_max);
        
subplot(1, 2, 2);
img(ligne_min:ligne_max,colonne_min:colonne_max) = bas_visage;
imagesc(img);
title({['Image reconstruite : posture ' num2str(posture_proche) ' de ', liste_personnes_base{personne_proche}]}, 'FontSize', 20);
axis image;
